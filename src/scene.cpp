...
void Scene::load( void )
{
    ...
    primitives_.push_back( Primitive::PrimitiveUniquePtr( new Sphere(glm::vec3{ -0.5f, 0.5f, 0.0f }, 0.3f,  new CookTorrance(glm::vec3{0.549f,0.565f,0.578f}) ) ) );
     primitives_.push_back( Primitive::PrimitiveUniquePtr( new Sphere(glm::vec3{ 0.5f, 0.5f, 0.0f }, 0.3f,  new SmoothDielectric() ) ) );
